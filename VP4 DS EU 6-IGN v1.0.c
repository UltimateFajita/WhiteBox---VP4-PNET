...
{		
	...
	//Portugese Req
	if((rxframe[1].cdat[0] == 0x0A) && (rxframe[1].cdat[1] == 0x03) && (rxframe[1].cdat[2] == 0x06))
	{
		flag_eng = 0;
		flag_spa = 0;
		flag_ger = 0;
	...
	// Dutch Req
	if((rxframe[1].cdat[0] == 0x0A) && (rxframe[1].cdat[1] == 0x03) && (rxframe[1].cdat[2] == 0x07))
	{
		flag_eng = 0;
		flag_spa = 0;
		flag_ger = 0;
	...
	// Polish Req
	if((rxframe[1].cdat[0] == 0x0A) && (rxframe[1].cdat[1] == 0x03) && (rxframe[1].cdat[2] == 0x11))
	{
		flag_eng = 0;
		flag_spa = 0;
		flag_ger = 0;
	...
	// Turkish Req
	if((rxframe[1].cdat[0] == 0x0A) && (rxframe[1].cdat[1] == 0x03) && (rxframe[1].cdat[2] == 0x10))
	{
		flag_eng = 0;
		flag_spa = 0;
		flag_ger = 0;
	...
	// Russian Req
	if((rxframe[1].cdat[0] == 0x0A) && (rxframe[1].cdat[1] == 0x03) && (rxframe[1].cdat[2] == 0x0A))
	{
		flag_eng = 0;
		flag_spa = 0;
		flag_ger = 0;
...
void lang_cfg()
{
		...
		if (flag_por == 1)			// Set language configuration based on check_lang() function ---- English
		{
		shortdelay();
		txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
		txframe.arbID= 0x332;		  //Message ID VR off									
		...
		if (flag_dut == 1)			// Set language configuration based on check_lang() function ---- English
		{
		shortdelay();
		txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
		txframe.arbID= 0x332;		  //Message ID VR off									
		...
		if (flag_pol == 1)			// Set language configuration based on check_lang() function ---- English
		{
		shortdelay();
		txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
		txframe.arbID= 0x332;		  //Message ID VR off									
		...
		if (flag_tur == 1)			// Set language configuration based on check_lang() function ---- English
		{
		shortdelay();
		txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
		txframe.arbID= 0x332;		  //Message ID VR off									
		...
		if (flag_rus == 1)			// Set language configuration based on check_lang() function ---- English
		{
		shortdelay();
		txframe.MsgNum = 12;			  //Message number(sequential starting at 1 for unique messages							
		txframe.arbID= 0x332;		  //Message ID VR off									
