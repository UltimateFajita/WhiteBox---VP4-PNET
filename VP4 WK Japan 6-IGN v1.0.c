...
{	
		...
		char VIN[17] = "1C3CCCCB7FN1124UC";
			...
			txframe.arbID = 0x2AD;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x07;	 // lever in reverse     					
			txframe.cdat[3] = 0x00;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x2C2;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 4;				  //8 bytes
			txframe.cdat[0] = 0xFF;	      						
			txframe.cdat[1] = 0xFF;	
			txframe.cdat[2] = 0xFF;	 // lever in reverse     					
			txframe.cdat[3] = 0x00;	  		  
			tx_can_frame(0);

			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x2C5;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x03;	      						
			txframe.cdat[1] = 0x00;	
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x2FA;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0x01;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x305;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3A2;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 6;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0x0F;	
			txframe.cdat[2] = 0xFF;	 // lever in reverse     					
			txframe.cdat[3] = 0x00;	  
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3B2;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x03;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0xFF;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3B3;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3B4;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3DE;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x00;	      						
			txframe.cdat[1] = 0xFF;	
			txframe.cdat[2] = 0xFF;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3E4;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x81;	      						
			txframe.cdat[1] = 0xC0;	
			txframe.cdat[2] = 0x80;	 // lever in reverse     					
			txframe.cdat[3] = 0x00;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3E3;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x11;	      						
			txframe.cdat[1] = 0x04;	
			txframe.cdat[2] = 0x20;	 // lever in reverse     					
			txframe.cdat[3] = 0x08;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3E8;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x41;	      						
			txframe.cdat[1] = 0x01;	
			txframe.cdat[2] = 0x26;	 // lever in reverse     					
			txframe.cdat[3] = 0x10;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0xFF;
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3E9;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0xFF;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3EA;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0xFF;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3EB;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x40;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x44A;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x44C;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x381;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x00;	
			txframe.cdat[2] = 0x00;	 // lever in reverse     					
			...
			shortdelay();
			txframe.MsgNum = 13;			  //Message number(sequential starting at 1 for unique messages							
			txframe.arbID = 0x3F2;		  //Message ID VR active message byte 5 x02										
			txframe.sz = 8;				  //8 bytes
			txframe.cdat[0] = 0x01;	      						
			txframe.cdat[1] = 0x06;	
			txframe.cdat[2] = 0xDF;	 // lever in reverse     					
			txframe.cdat[3] = 0x00;	  
			txframe.cdat[4] = 0x00;	      						
			txframe.cdat[5] = 0x00;	
			txframe.cdat[6] = 0x00;
